    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchedulingInformation", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Options_Question_MultipleChoiceQuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchedulingInformationId = table.Column<int>(type: "int", nullable: true),
                    SendingInformation_StartsAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    SendingInformation_EndsAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Survey", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Survey_SchedulingInformation_SchedulingInformationId",
                        column: x => x.SchedulingInformationId,
                        principalTable: "SchedulingInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SurveyQuestion", x => new { x.SurveyId, x.QuestionId, x.Order });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Options_MultipleChoiceQuestionId",
                table: "Options",
                column: "MultipleChoiceQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_Survey_SchedulingInformationId",
                table: "Survey",
                column: "SchedulingInformationId");
